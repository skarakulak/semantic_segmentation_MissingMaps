...
parser.add_argument('-t','--test-sample-size', default=16, help='Sample size of the test batches')
parser.add_argument('-e','--eval-n-times', default=8, help='Number of batches to be tested at evaluation')
